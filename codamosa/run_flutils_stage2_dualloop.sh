...
export INPUT_DIR="$ROOT_DIR/final_mutmut_suite_flutils/stage1_sbst"
export OUTPUT_DIR="$ROOT_DIR/final_mutmut_suite_flutils/stage2_v3"
...
TARGET_MODULES=(
    ...
    "flutils.setuputils.cmd"
    "flutils.strutils"
    "flutils.txtutils"
    "flutils.validators"
)

echo "🚀 [强制神谕注入] 启动 dual_loop_engine.py 强攻 flutils..."
echo "----------------------------------------------------------------"
