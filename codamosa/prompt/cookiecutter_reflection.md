...
The following test case `{case_name}` FAILED in the execution sandbox while testing Cookiecutter.
...
1. Analyze the crash. Pay special attention to Cookiecutter's high reliance on disk I/O, file system templates, and Click CLI runner contexts.
