#!/bin/bash
# ==============================================================================
# 课题实验：flutils Stage 1 (SBST 基线重构) 批量测试生成脚本
# ==============================================================================

export ROOT_DIR="/root/CODAMOSA"
export OUTPUT_DIR="$ROOT_DIR/final_mutmut_suite_flutils/stage1_sbst"
export PROJECT_PATH="$ROOT_DIR/flutils_src" 
...
echo "🚀 开始批量生成 flutils 目标模块的 Stage 1 测试用例..."
...
echo "🎉 flutils 的 Stage 1 基线数据重构完毕！"